...
def get_speaker_embedding_model(device: torch.device = None, cache_dir: str = None):
    conf = {
        ...
        "embedding_model": {
            "obj": "anyasfriend.components.spk.speakerlab.models.campplus.DTDNN.CAMPPlus",
            "args": {
                "feat_dim": 80,
                "embedding_size": 192,
            },
        ...
        "feature_extractor": {
            "obj": "anyasfriend.components.spk.speakerlab.process.processor.FBank",
            "args": {
                "n_mels": 80,
                "sample_rate": 16000,
                "mean_nor": True,
...
def get_cluster_backend():
    conf = {
        "cluster": {
            "obj": "anyasfriend.components.spk.speakerlab.process.cluster.CommonClustering",
            "args": {
